                    ...
                    <div className="p-2">
                        <form onSubmit={onSubmit}>
                            <div className="flex flex-col my-2 justify-center min-w-[350px]">
                                ...
                                <input placeholder="Username" value={username} onChange={(event) => setUsername(event.target.value)} required className="shadow appearance-none border w-full py-3 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline mt-1" id="username" type="text" name='name' />
                            </div>
                            <div className="flex flex-col my-2 justify-center sm:min-w-[350px]">
                                <label htmlFor="email">Email</label>
                                <input placeholder="Email" value={email} onChange={(event) => setEmail(event.target.value)} required className="shadow appearance-none border w-full py-3 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline mt-1" id="email" type="email" name='email' />
                            </div>
                            <div className="flex flex-col my-2 justify-center sm:min-w-[350px]">
                            ...
                            <div className="flex flex-col my-2 justify-center sm:min-w-[350px]">
                                ...
                                <input placeholder="****" value={confirm_password} onChange={(event) => setConfirm_password(event.target.value)} required className="shadow appearance-none border w-full py-3 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline mt-1" id="confirm_password" type="password" name='confirm_password' />
                            </div>
